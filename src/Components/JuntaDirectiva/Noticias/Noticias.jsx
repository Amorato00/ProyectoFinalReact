                ...
                <div className="row">
                    <div className="col-12 px-5">
                        ...
                        <div className="text-left text-lg-right mb-5">
                            ...
                            >
                            {" "}
                            <i class="fas fa-plus pr-3 p-1 p-md-2"></i> Añadir Concepto
                            </button>
                        </div>
                        <h4 className="text-white">Selecciona una de las NOTICIAS para pasar al modo editor</h4>
                        <NoticiasLista search={search}
                        ref={element => {
